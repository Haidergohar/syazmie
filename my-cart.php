...
?>
 ...
 <div class="banner-top">
	<div class="container">
		<h3 >My Cart</h3>
		<h4><a href="index.php">Home</a><label>/</label>MyCart</h4>
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active' style="display:inline;">Shopping Cart</li> -->
			</ul>
	...
	?>
				...
				<tr>
					...
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="product.php?pid=<?php echo htmlentities($pd=$row['id']);?>" ><?php echo $row['productName'];

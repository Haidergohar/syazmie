...
$page_title = "Search for ".$_POST['product']. " - ZP SEMBS ENTERPRISE";
...
<!--content-->
		...
		<div class="container">
			<div class="spec ">
                ...
                <!-- ------------------------------ start fetching data for search result ------------------------------ -->
<?php
...
?>
                ...
                <!-- ------------------------------ end fetching data for search result ------------------------------ -->
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<div class="price_single">
									  <span class="reducedfrom "><del><?php echo htmlentities($row['productPriceBeforeDiscount']);?>PKR </del> <?php echo htmlentities($row['productPrice']);?>PKR</span>
